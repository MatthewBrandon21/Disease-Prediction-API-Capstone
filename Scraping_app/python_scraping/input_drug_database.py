...
drugReviews = pd.read_csv('result_data/drugs.csv', delimiter = ',',encoding='utf-8')
...
for i in drugReviews.itertuples():
    ...
    sql = "INSERT INTO drugs (name, other_name, slug, description, excerpt, img, createdAt, updatedAt) VALUES (%s, %s, %s, %s, %s, %s, %s, %s)"
